                ...
                <div className="comite-header">
                    ...
                    <div className="comite-title">
                        ...
                        <div className="comite-buttons">
                            <a href="https://drive.google.com/drive/folders/1eJCRbV-j4guvx645hD4d9M8KS0A7CeZs?usp=share_link" className="button guia-button">Guia de Estudos</a>
                            <a href="https://drive.google.com/drive/folders/158A2h9Gu6lYnlzH1war_0ueu6UZ5Q35b?usp=share_link" className="button guia-button">Guia Anexo</a>
                        </div>
                    </div>
                </div>
