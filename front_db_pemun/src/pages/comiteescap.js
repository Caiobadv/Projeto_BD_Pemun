                ...
                <div className="comite-header">
                    ...
                    <div className="comite-title">
                        ...
                        <div className="comite-buttons">
                            <a href="https://drive.google.com/drive/folders/17oJLbMQRQULaWA6JQKFFZID02UodKZxn?usp=share_link" className="button guia-button">Guia de Estudos</a>
                            <a href="https://drive.google.com/drive/folders/1nz-0dEXRkM07hhJkangThqdt0-wFj8I-?usp=share_link" className="button guia-button">Guia Anexo</a>
                        </div>
                    </div>
                </div>
